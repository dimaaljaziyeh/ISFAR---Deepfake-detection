...
-- Detections
create type public.detection_result as enum ('real', 'fake');
...
create table public.detections (
  ...
  result detection_result not null,
...
create policy "Authenticated users can insert their own detections"
...
create index on public.detections (created_at desc);
create index on public.detections (user_id);
